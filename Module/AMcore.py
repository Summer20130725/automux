...
def install_Devploit():
    ...
    os.chdir("%s/Devploit/"%pwd)
    os.system("chmod +x Devploit install update.py")
    os.system("cd ..")
...
def install_ncmdump():
    print(colored("正在安装ncmdump，请稍等...","green"))
    os.system("apt update && apt upgrade -y")
    os.system("apt install clang make taglib git -y")
    os.system("git clone https://github.com/anonymous5l/ncmdump")
    os.chdir("%s/ncmdump/"%pwd)
    os.system("make")
    os.system("cp ncmdump -r $PREFIX/bin/")
    os.system("cd $HOME/")
    print(colored("安装完成可以直接在环境中输入ncmdump执行","blue"))
    print(colored("玩法:https://github.com/anonymous5l/ncmdump"))
    backmenu()


def install_qmcdump():
    print(colored("正在安装qmcdump，请稍等...","green"))
    os.system("apt update && apt upgrade -y")
    os.system("apt install make clang git taglib -y")
    os.system("git clone https://github.com/MegrezZhu/qmcdump")
    os.chdir("%s/qmcdump/"%pwd)
    os.system("make")
    os.system("cp qmcdump -r $PREFIX/bin/")
    os.system("cd $HOME/")
    print(colored("安装完成你可以直接在环境中输入qmcdump执行","blue"))
    print(colored("功能玩法:https://github.com/MegrezZhu/qmcdump","green"))
    okay()