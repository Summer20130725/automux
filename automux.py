...
class install:
    def xxsj():
        ...
        print(colored("       [12]","yellow") + " : Devpliot" + colored(" ! ","yellow"))
        print(colored("       [13]","yellow") + " : Devpliot_v1.1" + colored(" ! \n","yellow"))
        ...
        elif xxsj.strip() == "12" or xxsj.strip() == "12":install_Devploit()
        elif xxsj.strip() == "13" or xxsj.strip() == "13":install_Devploit_old()
    ...
    def wxcs():
        print(colored("\n       [01]","yellow") + " : Aircrack-ng" + colored(" * ","red"))
        print(colored("       [02]","yellow") + " : Wifite2" + colored(" * \n","red"))
        print(colored("       [00]","yellow") + " : Back Menu\n")
        wxcs = input(colored("AutoMux >>> ","yellow",attrs=['bold']))
        if wxcs.strip() == "1" or wxcs.strip() == "01":install_aircrack_ng()
        elif wxcs.strip() == "2" or wxcs.strip() == "02":install_wifite()
        elif wxcs.strip() == "0" or wxcs.strip() == "00":restart()
        else:error()


    def xtqp():
        print(colored("\n       [01]","yellow") + " : Bettercap" + colored(" * ","red"))
        print(colored("       [00]","yellow") + " : Back Menu\n")
...
def install_list():
    ...
    print(colored("       [05]","yellow") + " : 无线测试")
    print(colored("       [06]","yellow") + " : 嗅探和欺骗")
    ...
    elif ilist.strip() == "5" or ilist.strip() == "5":install.wxcs()
    elif ilist.strip() == "6" or ilist.strip() == "06":install.xtqp()
    elif ilist.strip() == "7" or ilist.strip() == "07":install.lygj()
